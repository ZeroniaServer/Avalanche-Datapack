...
execute if score @s blizzardtime matches 1 run function weapons:snowglobe/start_wobble with storage snowglobe:blizzard
execute if score @s blizzardtime matches 6 run data merge entity @s {interpolation_duration:35,start_interpolation:0,transformation:{scale:[1.0f,1.0f,1.0f]}}
