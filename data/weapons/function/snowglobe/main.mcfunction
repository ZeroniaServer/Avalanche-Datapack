...
execute as @a[tag=!Knockout,tag=SnowMark,scores={snowmark=1}] at @s summon item_display run function weapons:snowglobe/mark_cloud with storage snowglobe:blizzard
...
execute as @e[type=item_display,tag=SnowMarkCloud,tag=!DespawnCloud] at @s run function weapons:snowglobe/trackplayer
...
execute as @a[tag=InFriendlyCloud,predicate=weapons:snowball_normal_mainhand] run item modify entity @s weapon.mainhand weapons:snowball_blizzard
execute as @a[tag=InFriendlyCloud,predicate=weapons:snowball_normal_offhand] run item modify entity @s weapon.offhand weapons:snowball_blizzard
execute as @a[tag=!InFriendlyCloud,predicate=weapons:snowball_blizzard_mainhand] run item modify entity @s weapon.mainhand weapons:snowball
execute as @a[tag=!InFriendlyCloud,predicate=weapons:snowball_blizzard_offhand] run item modify entity @s weapon.offhand weapons:snowball

#> Pulse
execute as @e[type=item_display,tag=StormCloudMain,scores={CmdData=10..265}] run function weapons:snowglobe/random_wobble
