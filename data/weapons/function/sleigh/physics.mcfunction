...
execute if score #bool math matches 1.. as @e[type=minecart,tag=vehicle] if score @s vehicle.id = .current vehicle.id at @s run function weapons:sleigh/rotate
execute if score #bool math matches 1.. at @s[tag=!SleighOffGround] run function weapons:sleigh/effects
