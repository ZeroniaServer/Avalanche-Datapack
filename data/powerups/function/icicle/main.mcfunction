...
execute as @a[scores={breakicicle=1..}] at @s run playsound block.glass.break master @a ~ ~ ~ 0.5 0.7
execute as @a[scores={breakicicle=1..}] at @s run playsound block.glass.break master @a ~ ~ ~ 0.5 1.2
