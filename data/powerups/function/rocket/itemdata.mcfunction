data merge entity @s[tag=!Voided] {PickupDelay:1000,Age:-32768,NoGravity:1b,Motion:[0.0d,-0.05d,0.0d]}
data merge entity @s[tag=Voided] {PickupDelay:1000,Age:-32768,NoGravity:1b,Motion:[0.0d,-0.02d,0.0d]}
