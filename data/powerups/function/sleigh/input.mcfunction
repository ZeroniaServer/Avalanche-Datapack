...
execute if score #input math matches 1.. unless score .s wasd matches 1.. if entity @s[predicate=wasd:sprint,tag=!CoalBlind,tag=!DrinkChoco] run scoreboard players set #sprint vehicle 1
...
execute on vehicle on vehicle run function powerups:sleigh/physics
