...
execute on passengers rotated as @s[type=minecart] if predicate powerups:sleigh_has_motion at @s positioned ^ ^1 ^1.2 if entity @e[type=item_display,tag=Snowman,tag=Spawned,tag=!Dying,distance=..1,scores={playerHP=1..}] run playsound snowmanrunover master @a ~ ~ ~ 1 0
execute on passengers rotated as @s[type=minecart] if predicate powerups:sleigh_has_motion at @s positioned ^ ^1 ^1.2 if entity @e[type=item_display,tag=Snowman,tag=Spawned,tag=!Dying,distance=..1,scores={playerHP=1..}] run playsound snowmanrunover master @a ~ ~ ~ 1 1.4
execute on passengers rotated as @s[type=minecart] if predicate powerups:sleigh_has_motion at @s positioned ^ ^1 ^1.2 run scoreboard players set @e[type=item_display,tag=Snowman,tag=Spawned,tag=!Dying,distance=..1] playerHP 0
...
execute on passengers rotated as @s[type=minecart] if predicate powerups:sleigh_has_motion at @s positioned ^ ^-0.5 ^ if entity @e[type=item_display,tag=Snowman,tag=Spawned,tag=!Dying,distance=..1,scores={playerHP=1..}] run playsound snowmanstomp master @a ~ ~ ~ 1 0
execute on passengers rotated as @s[type=minecart] if predicate powerups:sleigh_has_motion at @s positioned ^ ^-0.5 ^ if entity @e[type=item_display,tag=Snowman,tag=Spawned,tag=!Dying,distance=..1,scores={playerHP=1..}] run playsound snowmanstomp master @a ~ ~ ~ 1 1.4
execute on passengers rotated as @s[type=minecart] if predicate powerups:sleigh_has_motion at @s positioned ^ ^-0.5 ^ run scoreboard players set @e[type=item_display,tag=Snowman,tag=Spawned,tag=!Dying,distance=..1] playerHP 0
