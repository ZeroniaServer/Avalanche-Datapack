#Red
execute as @e[type=item_display,tag=Snowman,tag=Red,tag=Spawned,tag=!Targeting,tag=!Dying] at @s if entity @a[team=Green,tag=!Knockout,distance=..13] run function powerups:snowman/stop_all_anims
...
#Green
execute as @e[type=item_display,tag=Snowman,tag=Green,tag=Spawned,tag=!Targeting,tag=!Dying] at @s if entity @a[team=Red,tag=!Knockout,distance=..13] run function powerups:snowman/stop_all_anims
