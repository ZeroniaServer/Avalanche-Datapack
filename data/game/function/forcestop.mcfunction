execute if score $mcancel CmdData matches 1 if entity @s[type=player] run tellraw @a {translate:"lobby.customizer.editing",color:"#f089a8",with:[{selector:"@s",color:"#1dc6c7",bold:true}]}
