summon block_display ~ ~ ~ {Tags:["AvalancheEntity","SecondarySnowBlockDisplay","New"],brightness:{sky:15,block:5},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},block_state:{id:"minecraft:powder_snow"}}
