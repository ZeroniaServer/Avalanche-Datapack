...
execute as @a[tag=WarpGreen] at @s run particle flash{color:-1} -84 55 -150 0 0 0 0 2 force @s
...
execute as @a[tag=WarpRed] at @s run particle flash{color:-1} -39 51 -150 0 0 0 0 2 force @s
...
execute as @a[tag=WarpLobby,tag=!LeaveWarp] at @s run particle flash{color:-1} -63 51 -124 0 0 0 0 2 force @s
execute as @a[tag=WarpLobby,tag=LeaveWarp] at @s run particle flash{color:-1} ^ ^1 ^1 0 0 0 0 2 force @s
...
execute as @a[tag=WarpSettings] at @s run particle flash{color:-1} -59 52 -90 0 0 0 0 2 force @s
