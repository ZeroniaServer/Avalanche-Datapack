...
execute if score $TranslatorPage CmdData matches 3 run item replace entity @e[type=item_display,tag=Credit3,tag=Skull,tag=!Old,limit=1] contents with player_head[profile={id:[I;-2067122887,-1446099444,-2101201685,-734512121]}]
execute if score $TranslatorPage CmdData matches 3 run summon text_display ~ ~ ~ {Tags:["TranslatorCredit","Credit","Credit3","Name"],billboard:"fixed",transformation:{translation:[0f,0f,0f],scale:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},text:[{text:"Disapphire",color:"dark_gray"}],alignment:"center"}
