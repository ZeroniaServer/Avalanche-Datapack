...
execute positioned -56 52 -70 if entity @s[tag=!CancelParkour,distance=8..] at @s if predicate {type:"location_check","predicate":{"position":{"y":{"max":52}}}} run tag @s add CancelParkour
