...
setblock -56 53 -90 warped_wall_sign[facing=west]{front_text:{messages:[{translate:"customizer.edit.top",color:"red",bold:true},{translate:"customizer.edit",color:"red",bold:true},'',{text:"",click_event:{action:"run_command",command:"/trigger cancelMatch set 1"}}]},allow_op_features:true}
