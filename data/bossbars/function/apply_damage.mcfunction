...
execute if score $green_progress CmdData matches 140.. run function gameplay:avalanche/trigger_red
execute if score $red_progress CmdData matches 140.. run function gameplay:avalanche/trigger_green