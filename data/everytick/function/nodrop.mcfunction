...
execute if items entity @s contents clay[custom_data~{MineBarricade:1b}] run return run item modify entity @s contents {"type":"set_components","components":{"custom_data":"{NoDrop:1b,Blank:1b}"}}
