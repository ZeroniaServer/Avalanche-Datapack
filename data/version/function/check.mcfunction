...
execute unless score $WorldVersion CmdData matches 1041.. run function version:1_0_5/update
execute unless score $WorldVersion CmdData matches 1042.. run function version:1_0_7/update