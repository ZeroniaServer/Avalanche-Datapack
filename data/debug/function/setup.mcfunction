...
#> Messages
data modify storage avalanche:messages ResourcePack set value [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{text:"We strongly recommend you to ",color:"gray"},{text:"use the resource pack",bold:true,color:"red"},{text:". ",color:"gray"},{text:"[CLICK HERE TO DOWNLOAD]",color:"green",bold:true,underlined:true,click_event:{action:"open_url",url:"https://downloads.zeronia.org/resourcepack/avalanche/avalanche-resourcepack-v1.0.7.zip"}}]
data modify storage avalanche:messages OutdatedPack set value [{text:"[",color:"dark_gray"},{text:"!",color:"red",bold:true},{text:"] ",color:"dark_gray"},{text:"You are using an outdated version of the resource pack! ",color:"gray"},{text:"[CLICK HERE TO DOWNLOAD THE LATEST VERSION]",color:"green",bold:true,underlined:true,click_event:{action:"open_url",url:"https://downloads.zeronia.org/resourcepack/avalanche/avalanche-resourcepack-v1.0.7.zip"}}]
