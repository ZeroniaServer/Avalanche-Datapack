...
$execute rotated as @s positioned ^ ^ ^0.2 run scoreboard players operation @e[type=item_display,tag=barricade,limit=$(limit),distance=..2,sort=nearest] UUIDscore = $tempuuid UUIDscore
