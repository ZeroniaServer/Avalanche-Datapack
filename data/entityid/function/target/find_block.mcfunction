...
$execute as @e[type=item_display,predicate=player:matches_uuid,limit=$(limit)] at @s positioned ~ ~100 ~ run function powerups:barricade/tick
$execute as @e[type=item_display,predicate=player:matches_uuid,limit=$(limit)] at @s positioned ~ ~100 ~ run function powerups:barricade/checkbreak
kill